        ...
        <tr>
            ...
            <td width="200">
                <input class="easyui-datebox" id="startDate"
                       data-options="editable:false,width:97,onSelect:Public.onSelectStartDate" type="text"
                       name="startDate" value="{{$defaultStartDate}}"/>
                <input class="easyui-datebox" id="endDate"
                       data-options="editable:false,width:97,onSelect:Public.onSelectEndDate" type="text" name="endDate"
...
{{block name="rowList"}}
    <tr width="100%">
        ...
        <th formatter="Public.formatStatus" data-options="field:'status',align:'center',sortable:false" width="10%">状态
        </th>
        <th formatter="Public.formatDate" data-options="field:'createTime',align:'center',sortable:true" width="10%">
            创建日期
        </th>
    </tr>
{{/block}}
