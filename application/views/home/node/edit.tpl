...
{{block name="form"}}
    <tr>
        ...
        <td valign="top"><input class="easyui-textbox" type="text" name="code" value="{{$data.code}}"
        ...
        <td valign="top">
            <select class="easyui-combobox" name="groupId" data-options="editable:false,width:200">
                ...
                {{foreach $node_group_list as $node_group}}
                    <option value="{{$node_group@key}}"
                            {{if $node_group@key eq $data['groupId']}}selected{{/if}}>{{$node_group}}</option>
                {{/foreach}}
            </select>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td valign="top">
            <input type="text" class="easyui-numberspinner" name="sort" value="{{$data.sort}}"
