...
{{block name="form"}}
    <tr>
        ...
        <td valign="top"><input class="easyui-textbox" type="text" name="code" data-options="width:200, required:false">
        </td>
    </tr>
    <tr>
        <td align="right" valign="top"><font color="red">*</font> 显示名：</td>
        <td valign="top"><input class="easyui-textbox" type="text" name="name" data-options="width:200, required:false">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td valign="top">
            <input type="text" class="easyui-numberspinner" name="sort" value="0"
                   data-options="min:0,max:999,width:200"/>
        </td>
    </tr>
    <tr>
