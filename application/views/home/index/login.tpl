        ...
        <form id="loginForm" method="post">
            <table>
                <tr>
                    ...
                    <td><input class="easyui-textboxa"  type="text" name="uName" data-options="width:180" /></td>
                </tr>
                <tr>
                    <td align="right">密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
                    <td><input class="easyui-textboxa" type="password" name="password" data-options="width:180" /></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>
