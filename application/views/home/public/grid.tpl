...
{{block name="body"}}
    <div data-options="region:'north',height:{{$searchBlockHeight|default:"'auto'"}}"
         style="overflow:hidden; padding:5px;border-left: none; border-right: none; border-top:none;">
